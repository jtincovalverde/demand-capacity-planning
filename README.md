...
> Portfolio project created with AI-assisted development. The dataset and operating assumptions are synthetic and are used only to demonstrate a transparent planning workflow.
...
Forecasting by itself is not the decision. This project translates the forecast into labor hours and compares those requirements with current operating capacity.
